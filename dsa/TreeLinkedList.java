...
public class TreeLinkedList implements Tree {
    ...
    private TreeLinkedList parent, firstChild, nextSibling; //父亲，长子以及最大的弟弟
...
//返回当前节点的长子，若没有孩子，则返回null
    public TreeLinkedList fetFirstChild() {
        return firstChild;
    }
...
//返回当前节点后代元素的数目，即以当前节点为根的子树的规模
    public int getSize() {
        ...
        while(null != subtree) { //依次
            ...
            subtree = subtree.getNextSibling(); //所以孩子的后代数目
        }
        return size;
    }
...
//返回当前节点的高度
    public int getHeight() {
        ...
        TreeLinkedList subtree = firstChild; //从长子开始
        while(null != subtree) { //依次
            height = Math.max(height, subtree.getHeight()); //在所以孩子中取最大高度
            subtree = subtree.getNextSibling();
        }
        return height + 1; //即可取得当前节点的高度
    }
